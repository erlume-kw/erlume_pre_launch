							...
							<div>
								...
								<Accordion
									...
									<AccordionItem value="auth">
										<AccordionTrigger className="px-5 sm:px-6 py-3 sm:py-4 text-left">
							...
							<div>
								...
								<Accordion
									...
									<AccordionItem value="inspection">
										...
										<AccordionContent className="px-5 sm:px-6 pb-4">
											<p className="text-foreground">
												Buyers are allowed a <strong>10-minute in-person inspection</strong> of the product. Once the purchase is confirmed, <strong>no returns or refunds</strong> will be accepted.
											</p>
										</AccordionContent>
									</AccordionItem>
									...
									<AccordionItem value="payment">
										...
										<AccordionContent className="px-5 sm:px-6 pb-4">
											<p className="text-foreground">
												Buyers must <strong>pay the full amount before delivery</strong> is arranged.
											</p>
										</AccordionContent>
									</AccordionItem>
									...
									<AccordionItem value="contact-agreement">
										...
										<AccordionContent className="px-5 sm:px-6 pb-4">
											<p className="text-foreground">
												Buyers approve receiving the <strong>seller’s contact number</strong> for any post-sale clarification or coordination if necessary.
											</p>
										</AccordionContent>
									</AccordionItem>
									...
									<AccordionItem value="final-sale">
										...
										<AccordionContent className="px-5 sm:px-6 pb-4">
											<p className="text-foreground">
												Once a buyer confirms the purchase after inspection, <strong>the sale is final</strong>.
											</p>
										</AccordionContent>
									</AccordionItem>
								</Accordion>
